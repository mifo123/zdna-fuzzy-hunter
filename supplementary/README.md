...
The exact Shin benchmark is reproduced from the versioned input and expected
metrics under `validation/data/`; these repository files are not part of the
numbered supplementary sequence because Supplementary Table S1 is the compact
per-locus publication output.
